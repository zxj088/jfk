...
function addListeners() {
  ...
  els.aboutButton?.addEventListener('click', async () => {
    ...
    await showMessage(
      ...
      t('No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.4.0.')
    );
  });
...
if ('serviceWorker' in navigator) {
  ...
  navigator.serviceWorker.addEventListener('controllerchange', () => {
    const reloadKey = 'jfk.simpleGolfSwReload.v206';
