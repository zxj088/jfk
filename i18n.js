(() => {
  ...
  const zh = {
    ...
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.1.17.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛战况、查看历史记分卡，以及多设备云端同步。版本 6.1.17。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.2.0.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.2.0。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.2.2.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.2.2。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.3.0.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.3.0。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.3.1.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.3.1。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.3.2.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.3.2。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.4.0.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.4.0。',
    'No account or sign-in required. Simple Golf Scorecard supports Las Vegas and Wolf & Pack scoring, live match viewing, historical scorecards, and cloud synchronization across devices. Version 6.5.7.': '无需注册或登录，打开链接即可使用。支持拉斯和斗地主记分、实时观看比赛、查看历史记分卡，以及多设备云端同步。版本 6.5.7。',
    'Add to phone desktop': '添加到手机桌面',
    'App installed': '应用已安装',
    'This app is already installed on this phone.': '此应用已经安装在这台手机上。',
    'Install on iPhone or iPad': '在 iPhone 或 iPad 上安装',
    'On iPhone or iPad:\n1. Tap the Share button (a square with an upward arrow).\n2. Scroll and choose Add to Home Screen.\n3. Keep Open as Web App enabled, then tap Add.': '在 iPhone 或 iPad 上：\n1. 点击“分享”按钮（方框上箭头）。\n2. 向上滑动并选择“添加到主屏幕”。\n3. 保持“作为网页 App 打开”，然后点击“添加”。',
    'On iPhone or iPad, first open this page in Safari. Then tap Share, choose Add to Home Screen, and tap Add.': '请先用 Safari 打开此页面，然后点击“分享”，选择“添加到主屏幕”，最后点击“添加”。',
    ...
    'Results': '成绩',
    'Courses': '球场',
    'Add courses to your available course list': '添加球场到可选球场列表',
    'Views': '页面',
    'Local only': '仅保存在本机',
    'Edit': '编辑',
    'Edit Info': '修改信息',
    ...
    'Under Par Flip On': '低于标准杆翻转开启',
    'Under Par Flip Off': '低于标准杆翻转关闭',
    'Flip': '翻转',
    'Birdie flip': '低于标准杆翻转',
    'Add Course': '添加球场',
    'Search Course': '搜索球场',
    'Manual Add': '手动添加',
    'Popular countries': '常用国家',
    'All countries A-Z': '全部国家（拼音排序）',
    'Popular regions': '常用地区',
    'All regions A-Z': '全部地区',
    'Enter the course details, then confirm PAR and difficulty for all 18 holes.': '先填写球场基本信息，再确认全部18洞的标准杆和难度。',
    'Course details': '球场信息',
    '18-hole scorecard': '18洞资料',
    'Course name': '球场名称',
    'Holes': '球洞数',
    '9 holes': '9洞',
    '18 holes': '18洞',
    '{count} holes': '{count}洞',
    'Garmin course library': 'Garmin球场名称库',
    'Loading the Garmin course library...': '正在加载全球Garmin球场名称库…',
    'Search the Garmin course library, then add a course.': '搜索全球Garmin球场名称库，然后添加球场。',
    'Searching the Garmin course library...': '正在搜索全球Garmin球场名称库…',
    'Could not load the Garmin course library. Add the course manually.': '无法加载Garmin球场名称库，请手动添加球场。',
    'Filters changed. Search again.': '筛选条件已改变，请重新搜索。',
    'Select at least 9 holes or 18 holes.': '请至少选择9洞或18洞。',
    'No courses found in the Garmin course library.': 'Garmin球场名称库中没有找到球场。',
    'No courses found. Change the filters or add one manually.': '没有找到球场，请修改筛选条件或手动添加。',
    'Found {count} Garmin courses.': '找到{count}个Garmin球场。',
    'Page {current} of {total}': '第{current}/{total}页',
    'Garmin identifies this as a 9-hole course. Confirm all 18 holes manually before saving.': 'Garmin将此球场标记为9洞。保存前请手动确认全部18洞资料。',
    'Garmin supplies the course name and location only. Confirm PAR and difficulty for all 18 holes before saving.': 'Garmin只提供球场名称和位置。保存前请确认全部18洞的标准杆和难度。',
    'Previous': '上一页',
    'Next': '下一页',
    'New Game': '新比赛',
    'Playing': '进行中',
    'History': '历史记录',
    'Main actions': '主要操作',
    'Every hole settled automatically': '自动算清每洞输赢',
    'Enter scores; net scoring, flips, multipliers and running points are calculated for you.': '填入杆数，净杆、翻转、倍率和累计输赢自动计算。',
    'No account · Share a link to follow live': '无需注册 · 分享链接即可查看实时战况',
    'Start a game': '开始球局',
    'New game': '开始球局',
    'Choose game and players': '设置玩法和球员',
    'Set up Las Vegas or Wolf/Pack': '设置拉斯或斗地主规则',
    'Follow live group-game points': '查看球友局实时输赢',
    'Live games': '查看球友局实时输赢',
    'Last group game': '上次球局',
    'Last game': '上次球局',
    'Play again with same setup': '同样设置再来一场',
    'Play again': '同样设置再来一场',
    'Could not load the previous game.': '无法读取上一场比赛。',
    'Share live game': '分享实时战况',
    'Share final result': '分享最终成绩',
    'Share live': '分享实时战况',
    'Share result': '分享最终成绩',
    'Scores': '成绩',
    'Scorecard': '成绩',
    ...
    'Scoring basis': '计分口径',
    'Score by': '计分口径',
    'Net (game setting)': '净杆（比赛设定）',
    'Gross (game setting)': '总杆（比赛设定）',
    'Net (reference)': '净杆（仅供参考）',
    'Gross (reference)': '总杆（仅供参考）',
    'Net · Official': '净杆（比赛设定）',
    'Gross · Official': '总杆（比赛设定）',
    'Net · Reference': '净杆（仅供参考）',
    'Gross · Reference': '总杆（仅供参考）',
    '{view} reference view. This game is officially scored as {official}.': '当前为{view}参考结果，本场比赛正式按{official}结算。',
    ...
    'Holes in one': '一杆进洞',
    'Biggest swing': '最大输赢洞',
    'Biggest swing holes': '最大输赢洞',
    'Biggest swings': '最大输赢洞',
    'Times as Wolf': '当地主次数',
    'Times as Pack': '当农民次数',
    'Wolf total points': '当地主总输赢',
    'Pack total points': '当农民总输赢',
    'Wolf holes': '当地主次数',
    'Pack holes': '当农民次数',
    'As Wolf': '当地主总输赢',
    'As Pack': '当农民总输赢',
    ...
    'Points balance': '输赢合计',
    'Total score': '总成绩',
    'Multiplied holes': '翻倍洞',
    'Flipped holes': '翻转洞',
    'Multiplier holes': '翻倍洞',
    'Flip holes': '翻转洞',
    'Extra {points}': '多出 {points} 分',
    'Before flip {before}; after flip {after}; extra {extra}': '翻转前 {before} 分；翻转后 {after} 分；多出 {extra} 分',
    'Manual x{manual} × special x{special} = x{total}': '手动 x{manual} × 特殊成绩 x{special} = x{total}',
    'Tie': '平局',
    'Team {team}': '{team} 队',
    'Recommend to golfers': '推荐给球友',
    'JFK GOLF automatically calculates Las Vegas and Wolf/Pack group-game points, including net scoring, flips and multipliers. No account required.': 'JFK GOLF 自动计算拉斯和斗地主输赢，包括净杆、翻转和倍率，无需注册。',
    'Follow the live group-game points—no account required.': '查看球友局实时输赢，无需注册。',
    'View the final group-game result and hole-by-hole points.': '查看最终输赢和逐洞结果。',
    'The shared game is unavailable or has been deleted.': '分享的比赛不存在或已被删除。',
    'View calculation': '查看计算',
    'Wolf calculation': '地主计算',
    'Best {count} Pack calculation': '最佳{count}名农民计算',
    '{player}: {score} × {count} = {total}': '{player}：{score} × {count}＝{total}',
    '{players}: {scores} = {total}': '{players}：{scores}＝{total}',
    '{side} wins: {winnerTotal} is lower than {loserTotal}.': '{side}获胜：{winnerTotal}小于{loserTotal}。',
    'Tied at {total}; rule: {rule}.': '双方均为{total}；平局规则：{rule}。',
    'Multiplier: manual x{manual} × special x{special} = x{total}': '倍率：手动×{manual} × 特殊×{special}＝×{total}',
    'Points balance: {points} = 0': '积分校验：{points}＝0',
    'The Wolf': '地主',
    'The Pack': '农民',
    'Team {team} wins {points}': '{team}队本洞 +{points}',
    'Both teams tie this hole': '两队本洞打平',
    'Using {mode} scores: {scores}': '使用{mode}：{scores}',
    'Team A pair: {before}{after}': 'A队组合：{before}{after}',
    'Team B pair: {before}{after}': 'B队组合：{before}{after}',
    ' → {value} after flip': ' → 翻转后{value}',
    'Difference: {high} − {low} = {points}': '差值：{high} − {low}＝{points}',
    'Both teams had an under-par score, so no flip was applied.': '两队均有低于标准杆成绩，因此不翻转。',
    'No flip was applied.': '本洞没有翻转。',
    'Start scoring': '开始记分',
    ...
    '2. Set game rules': '2. 设置比赛规则',
    'Choose the game and players first, then confirm the scoring rules.': '先选择玩法和人数，再确认记分规则。',
    'Basic settings': '基本设置',
    'Fight the Landlord rules': '斗地主规则',
    'Game rules': '比赛规则',
    'Players and handicaps': '球员与差点',
    'Las Vegas uses 4 players.': '拉斯固定使用4名球员。',
    'Scoring help': '计分说明',
    'How scoring works': '计分说明',
    'Wolf selection help': '地主方式说明',
    'Wolf strokes ×': '地主杆数 ×',
    'vs best Pack total': '对比最佳农民总杆',
    'Compare with the best {count} Pack total': '对比最佳{count}位农民的总杆',
    'Add the lowest Pack scores; multiply the Wolf strokes by the same number.': '选取杆数最低的农民相加；地主杆数乘以相同人数。',
    'How to score a tie': '平局如何计算',
    'How many Pack scores?': '农民成绩取几人？',
    'Tie rule': '平局如何计算',
    'Pack scores used': '农民成绩取几人？',
    '{count} Pack player scores': '取{count}人',
    'Wolf: 5 strokes × {count} players = {total}': '地主：5杆 × {count}人 = {total}杆',
    'Pack: add the best {count} player scores': '农民：取最好的{count}人，杆数相加',
    'The side with fewer strokes wins': '两边比较，杆数少的一方获胜',
    'Example: Wolf {wolf} strokes counts as {total}; compare with the best {count} Pack scores.': '例如：地主{wolf}杆按{total}杆计算，对比最佳{count}位农民的杆数总和。',
    '3. Select players': '3. 选择球员',
    '3. Players and handicaps': '3. 球员与差点',
    '3. Players & handicaps': '3. 球员与差点',
    ...
    'The manual multiplier is agreed before teeing off on this hole. Bombs are calculated automatically when the gross score is below par.': '手动倍数为本洞开球前大家约定，炸弹是自动计算总杆低于标准杆翻倍',
    'More actions': '更多操作',
    'Game setup progress': '比赛设置进度',
    '{count} players': '{count}人',
    'Cap {cap}': '单洞封顶{cap}分',
    'Best {count} Pack scores': '取{count}个农民最佳成绩',
    'Wolf selection': '地主方式',
    'Rotating Wolf': '输赢轮换',
    'Fixed Wolf': '固定地主',
    'Rotating': '输赢轮换',
    ...
    'Too many incorrect attempts. Try again later.': '错误次数过多，请稍后再试。',
    'Cloud sync ok': '云同步成功',
    'Scoring phone': '记分设备',
    ...
    ,'Landlord vs': '地主PK'
    ,'best Pack scores': '个农民最佳成绩'
    ,'Best Pack scores': '农民最佳成绩数量'
    ,'Compares the sum of the selected number of lowest Pack scores with the Wolf score multiplied by that number.': '将所选数量的农民最低杆数相加，与地主杆数乘以该数量进行比较。'
    ,'When tied': '平局时'
    ,'No win or loss': '不输不赢'
    ,'Higher-handicap landlord wins': '高差点地主获胜'
    ,'Peasants win': '农民获胜'
    ,'Landlord wins': '地主获胜'
    ,'Pack wins': '农民获胜'
    ,'Wolf wins': '地主获胜'
    ,'Tie: {result}': '平局：{result}'
    ,'Fixed Wolf: {player}': '固定地主：{player}'
    ...
    ,'Wolf & Pack Rules': '斗地主规则'
    ,'Show Wolf & Pack rules': '查看斗地主规则'
    ...
    ,'Gross mode uses actual strokes. Net mode allocates handicap strokes by hole. Choose how many of the lowest Pack scores to add together; compare that sum with the Wolf score multiplied by the same number.': '总杆按实际杆数计算；净杆采用差点分洞让杆。选择若干个农民最低杆数相加，再与地主杆数乘以相同人数进行比较。'
    ...
    ,'Tied hole: Choose whether nobody wins, an eligible higher-handicap landlord wins, the peasants win, or the landlord wins.': '平局：可设置为不输不赢、高差点地主获胜、农民获胜或地主获胜。'
  };

  const en = {
    'Fight the Landlord': 'Wolf & Pack Scoring',
    'Fight the Landlord rules': 'Wolf & Pack rules',
    'Rotating Wolf': 'Result Rotation',
    'Landlord': 'The Wolf',
    'Landlord vs': 'The Wolf vs',
    'Peasant': 'The Pack',
    'best Pack scores': 'best Pack scores',
    'Best Pack scores': 'Best Pack scores',
    'Best {count} Pack scores': 'Best {count} Pack scores',
    'When tied': 'When tied',
    'No win or loss': 'No win or loss',
    'Higher-handicap landlord wins': 'Higher-handicap Wolf wins',
    'Peasants win': 'The Pack wins',
    'Landlord wins': 'The Wolf wins',
    'Tie: {result}': 'Tie: {result}',
    'Fixed Wolf: {player}': 'Fixed Wolf: {player}',
    ...
    'Gross mode uses actual strokes. Net mode allocates handicap strokes by hole. Choose how many of the lowest Pack scores to add together; compare that sum with the Wolf score multiplied by the same number.': 'Gross mode uses actual strokes. Net mode allocates handicap strokes by hole. Choose how many of the lowest Pack scores to add together; compare that sum with The Wolf score multiplied by the same number.',
    ...
    ,'Tied hole: Choose whether nobody wins, an eligible higher-handicap landlord wins, the peasants win, or the landlord wins.': 'Tied hole: Choose whether nobody wins, an eligible higher-handicap Wolf wins, The Pack wins, or The Wolf wins.'
  };
